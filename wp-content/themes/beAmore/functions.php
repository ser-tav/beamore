<?php
	...
	function wpdocs_theme_setup() {
		...
		add_image_size('about-project', 800, 450, true);
	}
	...
	/// Шорткод галлереи 1
	function tab_gallery_1() {
		$images = get_field('tab_gallery_1');	
		if( $images ) {
			$string = '';
			$string .= '<div class="max-w-750 mb-110">';
				$string .=  '<div class="our_clients_slider">';
					foreach( $images as $image ) {
						$string .=  '<div>';
							$string .=  '<img src="'. esc_url($image['sizes']['about-project']). '" alt="'. esc_attr($image['alt']) .'" />';
						$string .=  '</div>';
					}
				$string .=  '</div>';
			$string .=  '</div>';
	...
	add_shortcode("tab_gallery_1", "tab_gallery_1");
	
	
	/// Шорткод галлереи 2
	function tab_gallery_2() {
		$images = get_field('tab_gallery_2');	
		if( $images ) {
			$string = '';
			$string .= '<div class="max-w-750 mb-110">';
				$string .=  '<div class="our_clients_slider">';
	...
	add_shortcode("tab_gallery_2", "tab_gallery_2");